    ...
    public void missingMandatoryCoreValues() {
        ...
        String[] dataRow = dataRow("ABCD",
                ...
                failure(
                 validHeader(),
                       dataRow,
                       "None of the expected address levels provided. " +
                       "value required for mandatory field: 'date of birth', " +
                       "value required for mandatory field: 'date of registration', " +
                       "value required for mandatory field: 'first name', " +
                       "value required for mandatory field: 'gender', " +
                       "value required for mandatory field: 'last name'"
                );
       }
